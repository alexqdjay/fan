...
<div class="row-fluid">
    <div class="content-box">
        ...
        <div class="content-box-main" style="min-height: 80px">
            <form class="form-horizontal" action="__URL__/../Store/save" method="POST">
                <legend>Store</legend>
                ...
                <!--  Addr  -->
                <div class="control-group">
                    <label class="control-label" for="inputAddr">Addr:</label>
                    <div class="controls">
                        <input type="text" id="inputAddr" value="<?php echo ($data["addr"]); ?>" name="addr">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input type="text" id="inputTel" value="<?php echo ($data["tel"]); ?>" name="tel">
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <textarea id="inputSummary"  name="summary"><?php echo ($data["summary"]); ?></textarea>
                    </div>
                </div>
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <select id="selectStatus" value="<?php echo ($data["active"]); ?>" name="active">
...
<script src="__URL__/../../../public/JS/Admin/store.js"></script>
    </div>
</section>
<!-- Socket -->
<section id="socket">
