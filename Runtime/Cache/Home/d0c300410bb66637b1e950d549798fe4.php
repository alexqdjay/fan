...
<div class="row-fluid">
    	...
    	<div class="pagination pagination-right" id="pagination1">
		      	<ul>
		      		<li class=""><a onclick="onClickPre()" style="cursor:pointer;">&lt;&lt;</a></li>
   					<?php $__FOR_START_14186__=1;$__FOR_END_14186__=$count+1;for($i=$__FOR_START_14186__;$i < $__FOR_END_14186__;$i+=1){ ?><li class=""><a href="#<?php echo ($i); ?>" onclick="onClickPagination(<?php echo ($i); ?>);"><?php echo ($i); ?></a></li><?php } ?>
 ...
 $price = (float)$vo['price']; echo sprintf('%01.1f',$price); ?></td>
      ...
      <div class="pagination pagination-right" id="pagination2">
	      	<ul>
	      		<li class=""><a onclick="onClickPre()" style="cursor:pointer;">&lt;&lt;</a></li>
  					<?php $__FOR_START_5211__=1;$__FOR_END_5211__=$count+1;for($i=$__FOR_START_5211__;$i < $__FOR_END_5211__;$i+=1){ ?><li class=""><a href="#<?php echo ($i); ?>" onclick="onClickPagination(<?php echo ($i); ?>);"><?php echo ($i); ?></a></li><?php } ?>
  					<li class=""><a onclick="onClickNext();" style="cursor:pointer;">&gt;&gt;</a></li>
		  	</ul>
      </div>
    </div>
