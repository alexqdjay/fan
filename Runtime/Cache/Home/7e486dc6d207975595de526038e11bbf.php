	...
	<div class="pagination pagination-right" id="pagination1">
      	<ul>
      		<li><a onclick="onClickPre()" style="cursor:pointer;">&lt;&lt;</a></li>
				<?php $__FOR_START_9509__=1;$__FOR_END_9509__=$count+1;for($i=$__FOR_START_9509__;$i < $__FOR_END_9509__;$i+=1){ ?><li class="pagination-count"><a href="#<?php echo ($i); ?>" id="paginationCount_<?php echo ($i); ?>" onclick="onClickPagination(<?php echo ($i); ?>);"><?php echo ($i); ?></a></li><?php } ?>
